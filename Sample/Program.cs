...
namespace GraphBulkExecutorV3.Sample
{
    ...
    class Program
    {
        ...
        private static string databaseName = "vConnect";
        private static string containerName = "test";
        private static long documentsToInsert = 1000;
        ...
        private static IEnumerable<GremlinVertex> GenerateVertices(long count)
        {
            ...
            for (long i = 0; i < count; i++)
            {
                ...
                v.AddProperty(Program.partitionKey, Program.partitionKey);
